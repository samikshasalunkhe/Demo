// // src/dashboard/faculty/FacultyProfile.jsx

// import React from "react";
// import { Mail, Phone, Briefcase, Calendar, UserCircle, Edit } from "lucide-react";
...
//     phone: "+91-9876543210",
//     joinDate: "July 15, 2020",
//     role: "Assistant Professor",
//   };

//   return (
//     <div className="p-6 bg-gradient-to-br from-purple-900 via-[#1e1b4b] to-gray-900 text-white min-h-screen">
//       <h2 className="text-3xl font-bold text-purple-400 mb-6">Faculty Profile</h2>

//       <div className="bg-[#1e293b] rounded-2xl p-6 shadow-lg max-w-3xl mx-auto flex flex-col md:flex-row gap-6 items-center">
//         {/* Profile Image Placeholder */}
//         <div className="w-36 h-36 bg-gradient-to-br from-purple-500 to-indigo-500 rounded-full flex items-center justify-center shadow-lg">
//           <UserCircle size={64} />
//         </div>
...
//           <button className="mt-4 inline-flex items-center gap-2 bg-purple-700 hover:bg-purple-800 text-white font-medium px-4 py-2 rounded-lg shadow-md transition">
//             <Edit size={18} />
//             Edit Profile
//           </button>
//         </div>
