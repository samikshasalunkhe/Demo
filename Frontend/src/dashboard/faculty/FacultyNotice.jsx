...
const FacultyNotices = () => {
  ...
  return (
    <div className="p-6 bg-gradient-to-br from-purple-900 to-purple-700 min-h-screen text-white">
      ...
      <div className="mb-10">
        ...
        {adminNotices.length === 0 ? (
          <p className="text-gray-200">No admin notices available for faculty.</p>
        ) : (
          <div className="grid gap-4">
            {adminNotices.map((notice) => (
              <div
                key={notice._id}
                className="bg-white bg-opacity-10 backdrop-blur-md p-5 rounded-lg shadow-md"
              >
                <h4 className="text-xl text-gray-900 font-bold ">{notice.title}</h4>
                <p className="text-sm text-gray-800 mt-2">{notice.content}</p>
        ...
        {myNotices.length === 0 ? (
          ...
          <div className="grid gap-4">
            {myNotices.map((notice) => (
              ...
              >
                <h4 className="text-xl text-gray-900 font-bold ">{notice.title}</h4>
                <p className="text-sm text-gray-900 mt-2">{notice.content}</p>
