...
import { Pencil, Trash2 } from 'lucide-react'; // ✅ ICONS IMPORT
...
const ManageFaculty = () => {
  ...
  return (
    <div className="min-h-screen p-6 bg-gradient-to-br from-gray-900 via-purple-900 to-gray-800 text-white">
      ...
      {/* ✅ Updated Table UI with Purple Shade and Icon Buttons */}
          ...
          <tbody>
            {filteredFaculties.length > 0 ? (
              filteredFaculties.map((fac) => (
                <tr
                  key={fac._id}
                  className="hover:bg-purple-300/10 transition-all duration-300"
                >
              ...
              <tr>
                <td colSpan="10" className="text-center p-6 text-white">
