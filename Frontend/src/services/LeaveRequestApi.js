...
// // 📌 Admin → Faculty leaves fetch karaycha
...
//   const token = localStorage.getItem("token");
//   const res = await axios.post(`${API_URL}/create`, leaveData, {
//     headers: { Authorization: `Bearer ${token}` }
//   });
//   return res.data;
// };
...
//   const token = localStorage.getItem("token");
//   const res = await axios.put(`${API_URL}/${id}`, leaveData, {
//     headers: { Authorization: `Bearer ${token}` }
//   });
//   return res.data;
// };
