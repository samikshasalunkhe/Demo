...
import {
  ...
  FaClipboardList, FaUsers, FaBook, FaUserTie, FaCalendarAlt, FaSignOutAlt,FaEye,FaRegCalendarAlt
} from "react-icons/fa";
  ...
  return (
    <aside className="w-70 h-screen overflow-y-auto bg-slate-900 text-white p-5 shadow-lg">
      ...
      <nav className="flex flex-col gap-2">
        ...
        <SidebarItem to="/admin/leaverequests" label="Leave Request" icon={FaRegCalendarAlt} />
<Link to="/">
        {/* ✅ Logout Button */}
        <button
