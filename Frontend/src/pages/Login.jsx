...
const handleLogin = async (e) => {
  ...
  try {
    ...
    if (data.success) {
      ...
      if (data.user.role === "admin") navigate("/admin/admindashboard");
      else if (data.user.role === "faculty") navigate("/faculty/dashboard");
      else if (data.user.role === "student") navigate("/students/StudentDashboardMenu");
      else alert("Access Denied: Invalid Role");
    } else {
